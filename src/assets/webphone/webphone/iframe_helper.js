...
webphone_api.call = function (number) { SendMessageToFrame('webphone_api.call(' + number + ')'); };
webphone_api.videocall = function (number) { SendMessageToFrame('webphone_api.videocall(' + number + ')'); };
...
webphone_api.forward = function (number) { SendMessageToFrame('webphone_api.forward(' + number + ')'); };
webphone_api.conference = function (number, add) { SendMessageToFrame('webphone_api.conference(' + number + ',' + add + ')'); };
webphone_api.transfer = function (number) { SendMessageToFrame('webphone_api.transfer(' + number + ')'); };
webphone_api.dtmf = function (message) { SendMessageToFrame('webphone_api.dtmf(' + message + ')'); };
...
webphone_api.sendchat = function (number, msg) { SendMessageToFrame('webphone_api.sendchat(' + number + ',' + msg + ')'); };
webphone_api.sendsms = function (number, msg, from) { SendMessageToFrame('webphone_api.sendsms(' + number + ',' + msg + ',' + from + ')'); };
